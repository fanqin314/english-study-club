    ...
    ModuleRegistry.register('APIConfig', ['Security', 'ErrorHandler', 'Performance'], function(Security, ErrorHandler, Performance) {
        ...
        function fillAPISettings(modalContainer) {
            ...
            apiSection.innerHTML = `
                ...
                <label>模型名称</label>
                <input type="text" id="modelInput" placeholder="Qwen/Qwen3.5-27B" style="box-shadow: inset 0px 2px 10px -2px rgba(0, 0, 0, 0.25); background-color: rgba(245, 245, 245, 0.6); border-width: 1px; border-style: solid; border-color: #ededed; opacity: 0.9;">
